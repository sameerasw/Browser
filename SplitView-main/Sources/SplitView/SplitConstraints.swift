...
public struct SplitConstraints {
    ...
    /// The maximum fraction that the primary view will be constrained within. A value of `nil` means unconstrained.
    var maxPFraction: CGFloat?
    /// The maximum fraction that the secondary view will be constrained within. A value of `nil` means unconstrained
    var maxSFraction: CGFloat?
    ...
    public init(minPFraction: CGFloat? = nil, minSFraction: CGFloat? = nil, maxPFraction: CGFloat? = nil, maxSFraction: CGFloat? = nil, priority: SplitSide? = nil, dragToHideP: Bool = false, dragToHideS: Bool = false) {
        self.minPFraction = minPFraction
        self.minSFraction = minSFraction
        self.maxPFraction = maxPFraction
        self.maxSFraction = maxSFraction
