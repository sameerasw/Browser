...
//                        .offset(sOffset)
    ...
    public func constraints(minPFraction: CGFloat? = nil, minSFraction: CGFloat? = nil, maxPFraction: CGFloat? = nil, maxSFraction: CGFloat? = nil, priority: SplitSide? = nil, dragToHideP: Bool = false, dragToHideS: Bool = false) -> Split {
        let constraints = SplitConstraints(minPFraction: minPFraction, minSFraction: minSFraction, maxPFraction: maxPFraction, maxSFraction: maxSFraction, priority: priority, dragToHideP: dragToHideP, dragToHideS: dragToHideS)
